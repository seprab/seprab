...
description: >-
  I share my experience for looking how to use a docker container for using
  Unity and building Android apps. The result is a small repositoriy with the
  required files to build and use it.
pubDate: 2023-03-16
tags: [unity, docker, android, ci]
---
